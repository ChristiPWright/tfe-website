    ...
    <div class="d-flex flex-column moqui-navbar">
        <div class="container d-flex flex-row main-navbar">
            <a class="navbar-brand d-none d-sm-block"  href="/store">
                ...
                <span class="font-italic navbar-title">Beth Summers: Artist</span>
            </a>
            ...
            <div class="navbar-collapse collapse">
                <form id="form-search" class="search-input" action="#">
                    <input type="text" placeholder="navbar.html.fl edit: Search..." name="search" id="search" value="${searchParameter!''}">
                ...
                <ul class="navbar-nav ml-auto">
                    <div class="text-secondary">
                        <span class="navbar-pop-title">Beth Summers: Artist</span>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item item-color" href="/store/content/about">navbar.html.fl edit: About POP Shop</a>
